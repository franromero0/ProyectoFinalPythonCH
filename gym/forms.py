...
class EditarUsuario(UserCreationForm): 
                                        first_name = forms.CharField(required=False,
                                                                ...
                                                                widget=forms.TextInput(attrs={'placeholder': 'Ingrese su nombre', 'style': 'font-size: 12px;'
                                                                                                            }))
                                        email = forms.EmailField(required=False,label="Correo electronico")
                                        password1 = forms.CharField(required=False,max_length=100, label="Ingrese la contraseña", widget=forms.PasswordInput(attrs={'placeholder': '********'}))
                                        password2 = forms.CharField(required=False,max_length=100, label="Confirme la contraseña", widget=forms.PasswordInput(attrs={'placeholder': '********'}))
...
class OutDoorForm(forms.ModelForm):
    ...
    titulo_evento = forms.CharField(
                            max_length=100,label="",
                            required=True,
                            widget=forms.TextInput(attrs={'placeholder': 'Ej. Arco de piedra - Mina clavero', 'style': 'font-size: 12px;'
                                                                        }),
                            help_text="Ingrese el titulo de la publicacion del evento: ")
    deport = forms.CharField(max_length=100,
                                 label="", 
                                 required=True,
                                 widget=forms.TextInput(attrs={'placeholder': 'Deporte','style': 'font-size: 12px;'
                                                               }),
    ...
    lugar_salida = forms.CharField(
                            max_length=100,label="",
                            required=True,
                            widget=forms.TextInput(attrs={'placeholder': 'Punto de partida', 'style': 'font-size: 12px;'
                                                                        }),
                            help_text="Donde iniciará el evento:")
    short_description = forms.CharField(
                            max_length=200,label="",
                            required=True,
                            widget=forms.TextInput(attrs={'placeholder': 'Descripción corta que se previsualizará', 'style': 'font-size: 12px;'
                                                                        }))
    description = forms.CharField(
                            max_length=1100,label="",
                            required=True,
                            widget=forms.TextInput(attrs={'placeholder': 'Descripción del evento detallada', 'style': 'font-size: 12px;'
                                                                        }))
...
class GymForm(forms.ModelForm):
    activity = forms.CharField(max_length=100,
                               required=True,
                               widget=forms.TextInput(attrs={'placeholder': 'Título. Ej. Kick Boxing or Musculación','style': 'font-size: 12px;'
                                                               }),
                               
                                help_text="¿Que actividad nueva quiere registrar?")
    description  = forms.CharField(max_length=1000,
                                   required=False, 
                                   widget=forms.TextInput(attrs={'placeholder': 'Se previsualizará en la portada','style': 'font-size: 12px;'
                                                               }),
                                 help_text="Descripcion de la actividad/deporte")
    days = forms.CharField(max_length=200, 
                           required=True, 
                           widget=forms.TextInput(attrs={'placeholder': 'formato: Lunes, Miercoles y Viernes ','style': 'font-size: 12px;'
                                                               }),
                                 help_text="Días que se brindará")
    hour = forms.CharField(max_length=200,
                           required=True,
                           widget=forms.TextInput(attrs={'placeholder':'Formato: de 6 p.m a 9 p.m o 17hs a 20hs', 'style': 'font-size: 12px;'}))
    prof = forms.CharField(max_length= 100, required=False, widget=forms.TextInput(attrs={'placeholder': 'Nombre del profesor(solamente nombre)','style': 'font-size: 12px;'
                                                               }),
                                 help_text="Ingrese el nombre del profesor de la clase")  
    place = forms.CharField(max_length= 100,
                            required=False,
                             
                            widget=forms.TextInput(attrs={'placeholder':'Ej. Salón Cardio','style': 'font-size: 12px;'
                                                               }),
